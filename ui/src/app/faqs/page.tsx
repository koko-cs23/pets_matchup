...
const FAQs = () => {
  return (
    <main className='flex gap-11 flex-col '>
      ...
      <div className='flex md:gap-2 flex-col text-justify my-8 mx-3 md:mx-16 lg:mx-32'>
        <HeaderAndTextAccordions
          header='What is [Website Name]?'
          text='[Website Name] is a platform dedicated to helping individuals find suitable mates for their pets. Whether you have a dog, cat, rabbit, or any other pet, we aim to connect pet owners to facilitate breeding, companionship, or playdates for their furry friends.'
        />
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='How does [Website Name] work?'
          text="[Website Name] works by providing a user-friendly interface where pet owners can create profiles for their pets. These profiles include details about the pet's breed, age, personality, and more. Users can then browse through these profiles to find potential mates or playmates for their pets. Once a match is found, users can communicate with each other through our platform to arrange meet-ups or breeding arrangements."
        />
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='Is [Website Name] only for breeding purposes?'
          text='No, [Website Name] is not just for breeding. While some users may be interested in finding mates for breeding, many others use our platform to find companions for their pets. This can include playdates, walks, or simply socializing with other pets. We aim to cater to a variety of needs.'
        />
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='Is it free to use [Website Name]?'
          text="Yes, basic usage of [Website Name] is free. You can create profiles for your pets, search for potential mates, and initiate conversations with other pet owners at no cost. However, we also offer premium features and subscriptions that provide additional benefits and enhanced visibility for your pet's profile."
        />
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='How do I create a profile for my pet?'
          text="To create a profile for your pet, simply sign up on [Website Name], and you will find an option to add a new pet profile in your account. You can provide details such as your pet's name, breed, age, photos, and a short description."
        />
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='Can I trust the other pet owners on [Website Name]?'
        ...
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='How can I contact other pet owners on [Website Name]?'
        ...
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='How do I report inappropriate content or behavior on [Website Name]?'
        ...
        <hr className='dark:opacity-30' />
        <HeaderAndTextAccordions
          header='I have a suggestion for improving [Website Name]. How can I share it with you?'
